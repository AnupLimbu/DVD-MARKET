...
namespace DVDMarket.Controllers
{
    public class CategoryModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,Name,Description,Limit,Duration,Coin")] CategoryModel categoryModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,Name,Description,Limit,Duration,Coin")] CategoryModel categoryModel)
        {
